...
const Drinks = ( ) => {
    ...
    const { categoryData } = useCoustom('drinks')
    return (
        <div className="mt-20">
            <div className='w-1/2'>
                <h1 className='text-4xl text-green-800 font-semibold'>Drinks & Bevarage ---</h1>
            ...
            <div className="text-center mt-10">
                <Link to='/order/drinks' className="btn bg-green-700 px-10">Order Now</Link>
            </div>
        </div>
    );
};
