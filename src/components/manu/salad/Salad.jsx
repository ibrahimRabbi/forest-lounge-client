...
const Salad = ( ) => {
    const { categoryData } = useCoustom('salad')
    return (
        <div className="mt-20">
                <div className='w-1/2  '>
                    <h1 className='text-4xl text-green-800 font-semibold'>Salad & Vegetable ---</h1>
            ...
            <div className="text-center mt-10">
                <Link to='/order/salad' className="btn bg-green-700 px-10">Order Now</Link>
            </div>
        </div>
    );
};
